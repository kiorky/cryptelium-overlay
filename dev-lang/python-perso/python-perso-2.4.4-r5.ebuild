...
DEPEND="
	>=sys-libs/zlib-$INSTANCE-1.1.3
	!dev-python/cjkcodecs
	!build? (
		tk? ( >=dev-lang/tk-8.0 )
		ncurses-$INSTANCE? ( >=sys-libs/ncurses-$INSTANCE-5.2 
		readline? ( >=sys-libs/readline-$INSTANCE-5.1 ) )
		berkdb? ( >=sys-libs/db-$INSTANCE-3.1 )
		gdbm? ( sys-libs/gdbm-$INSTANCE )
		ssl? ( dev-libs/openssl$INSTANCE )
		doc? ( =dev-python/python-docs-$INSTANCE-${PV}* )
		dev-libs/expat-$INSTANCE
	)"
